...
pub fn get_simple_adventurer() -> AdventurerVerbose {
    ...
    let equipment = EquipmentVerbose {
        ...
        chest: chest_item,
        head: ItemVerbose {
            id: 3, name: 'Crown', tier: Tier::T1, item_type: Type::Magic_or_Cloth, slot: Slot::Head, xp: 25,
        },
        waist: ItemVerbose {
            id: 4, name: 'Leather Belt', tier: Tier::T1, item_type: Type::Blade_or_Hide, slot: Slot::Waist, xp: 30,
        },
        foot: ItemVerbose {
            id: 5, name: 'Boots', tier: Tier::T1, item_type: Type::Blade_or_Hide, slot: Slot::Foot, xp: 40,
        },
        hand: ItemVerbose {
            id: 6, name: 'Gloves', tier: Tier::T1, item_type: Type::Blade_or_Hide, slot: Slot::Hand, xp: 20,
        },
        neck: ItemVerbose {
            id: 7, name: 'Amulet', tier: Tier::T1, item_type: Type::Necklace, slot: Slot::Neck, xp: 15,
        },
        ring: ItemVerbose {
            id: 8, name: 'Silver Ring', tier: Tier::T1, item_type: Type::Ring, slot: Slot::Ring, xp: 10,
        },
    };
