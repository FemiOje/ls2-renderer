...
// Unused trait imports commented out
// use death_mountain_renderer::models::models::StatsTrait;
// use death_mountain_renderer::utils::encoding::BytesUsedTrait;
...
pub fn create_test_adventurer() -> death_mountain_renderer::models::models::AdventurerVerbose {
