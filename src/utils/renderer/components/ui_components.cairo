...
//
// @title UI Components
// @notice Functions for generating common UI elements like stats display, gold, health bar, and level
// @dev Reusable UI components with theme support for consistent styling
// @author Built for the Loot Survivor ecosystem

use death_mountain_renderer::models::models::{Stats, StatsTrait};
use death_mountain_renderer::utils::renderer::components::theme::{get_theme_color, get_gold_background_color};
