...
use death_mountain_renderer::models::models::{BagVerbose, ItemVerbose, Slot};
...
/// @dev Provides fine-tuned positioning offsets for different item types to improve visual alignment
/// @param slot The slot type of the item
