...
use death_mountain_renderer::models::models::{BagVerbose};
use death_mountain_renderer::utils::renderer::components::theme::get_theme_color;
use death_mountain_renderer::utils::renderer::core::math_utils::get_greatness;
use death_mountain_renderer::utils::string::string_utils::{u8_to_string, u256_to_string};
use death_mountain_renderer::utils::renderer::bag::bag_utils::{
    get_bag_item_by_index, get_bag_item_words, get_item_icon_svg, get_icon_position_adjustment
};
...
/// @dev Creates themed icons for all bag items with proper positioning and icon-specific adjustments
/// @param bag The bag containing items to render
