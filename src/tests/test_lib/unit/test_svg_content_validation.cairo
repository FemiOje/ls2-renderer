...
fn create_adventurer_with_stats(str: u8, dex: u8, vit: u8, int: u8, wis: u8, cha: u8) -> AdventurerVerbose {
    let mut adventurer = get_simple_adventurer();
...
fn test_svg_contains_namespace() {
    ...
    assert!(contains_pattern(@svg, @"xmlns=\"http://www.w3.org/2000/svg\""), "SVG should have proper namespace");
}
...
fn test_svg_font_size_for_long_names() {
    let adventurer = create_adventurer_with_name("VeryVeryVeryVeryLongAdventurerName"); // > 30 chars - should use 12px
    let svg = generate_svg(adventurer);
...
fn test_svg_contains_weapon_icon() {
    ...
    assert!(contains_pattern(@svg, @"M8 4V3H6V2H5V1H3v2H2v2H1v1h2V5h2v2H4v2H3v2H2v2H1v2H0v2h2v-2h1v-2h1v-2h1V9h1V7h2v5h2v-2h1V8h1V6h1V4H8Z"), "SVG should contain weapon icon path");
}
...
fn test_svg_contains_chest_icon() {
    ...
    assert!(contains_pattern(@svg, @"M0 8h2V7H0v1Zm3-3V2H2v1H1v2H0v1h4V5H3Z"), "SVG should contain chest icon path");
}
...
fn test_svg_contains_head_icon() {
    ...
    assert!(contains_pattern(@svg, @"M12 2h-1V1h-1V0H6v1H5v1H4v1H3v8h1v1h2V8H5V7H4V5h3v4h2V5h3v2h-1v1h-1v4h2v-1h1V3h-1V2Z"), "SVG should contain head icon path");
}
...
fn test_svg_contains_border_elements() {
    ...
    assert!(contains_pattern(@svg, @"fill=\"#78E846\""), "SVG should contain green border elements");
    assert!(contains_pattern(@svg, @"fill=\"#000\""), "SVG should contain black background elements");
}
...
fn test_svg_contains_main_container() {
    ...
    assert!(contains_pattern(@svg, @"width=\"567\" height=\"862\""), "SVG should have main container dimensions");
...
fn test_svg_name_boundary_30_chars() {
    let adventurer = create_adventurer_with_name("012345678901234567890123456789"); // Exactly 30 chars
    let svg = generate_svg(adventurer);
...
fn test_svg_name_boundary_31_chars() {
    let adventurer = create_adventurer_with_name("0123456789012345678901234567890"); // 31 chars - should trigger small font
    let svg = generate_svg(adventurer);
