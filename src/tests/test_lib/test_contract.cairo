...
fn test_minigame_details_svg_interface_compliance() {
    ...
    assert(
        result_start.len() > 29, 'result too short for prefix',
...
fn test_complete_nft_metadata_integration() {
    ...
    assert(
        svg_data_uri.len() > 29, 'invalid data uri structure',
    ); // "data:application/json;base64," is 29 chars
...
fn test_memory_efficiency_large_sequences() {
    ...
    let large_ids = array![
        1000000_u64, 2000000_u64, 3000000_u64, 4000000_u64, 5000000_u64, 10000000_u64,
    ];
