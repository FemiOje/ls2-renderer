...
const SEPOLIA_DEATH_MOUNTAIN_ADDRESS: felt252 = 0x6492209fe1a4e397c335fd7b9d6a6f2e5beae22e14443134c1aa4eb755f3fce;
...
fn deploy_fork_renderer() -> ContractAddress {
    let death_mountain_address: ContractAddress = SEPOLIA_DEATH_MOUNTAIN_ADDRESS.try_into().unwrap();
